...
import 'package:widgets_app/config/theme/menu/manu_items.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return  NavigationDrawer(
      ...
      children: [
        ...
        Padding(padding:  EdgeInsets.fromLTRB(28, hasNotch? 0 : 20, 10, 10),
        ...
        Padding(padding:  EdgeInsets.fromLTRB(28, 10, 10, 10),
